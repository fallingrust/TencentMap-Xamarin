...
namespace Com.Tencent.Mapsdk.Raster.Model {
	...
	public sealed partial class Polygon : global::Java.Lang.Object, global::Com.Tencent.Mapsdk.Raster.Model.IOverlay {

		internal    new     static  readonly    JniPeerMembers  _members    = new XAPeerMembers ("com/tencent/mapsdk/raster/model/Polygon", typeof (Polygon));
		...
		public unsafe global::System.Collections.Generic.IList<global::Com.Tencent.Mapsdk.Raster.Model.LatLng> Points {
			...
			// Metadata.xml XPath method reference: path="/api/package[@name='com.tencent.mapsdk.raster.model']/class[@name='Polygon']/method[@name='setPoints' and count(parameter)=1 and parameter[1][@type='java.util.List&lt;com.tencent.mapsdk.raster.model.LatLng&gt;']]"
